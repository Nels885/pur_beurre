...
class Database:
    ...
    def __init__(self, log, conf_sql):
        """
        ## Initialize Class Database ##
            :param log: logging module
            :param conf_sql: dict of parameters for the configuration of the Database
        """
        self.log = log
        dbname = conf_sql['dbname']
        user = conf_sql['user']
    ...
    def insert(self, table, param, columns=None, return_id=False):
        """
        ## inserting values into a table ##
            ...
            :param return_id: valid if we want the ID of the line
        ...
        id_line = self.__return_id(req, param, return_id)
        return id_line
    ...
    def sql_script(self, sql_file):
        """
        ## Execute script SQL file ##
            :param sql_file: file to execute
            :return: execute the different SQL requests in the file
        """
        self.execute(open(sql_file, 'r').read())
    ...
    def __return_id(self, request, param, return_id):
        """
